(()=>{var p=!1,g=null,u=!1;function m(){let e=new URL(window.location.href),t=e.pathname.match(/\/product\/(\d+)\/(\d+)/);if(t&&t.length>2){let i=t[1];return t[2]}let n=e.search.match(/-i\.(\d+)\.(\d+)/);if(n&&n.length>2){let i=n[1];return n[2]}return null}function E(){if(document.getElementById("shopee-commission-widget-icon"))return;let e=document.createElement("div");e.id="shopee-commission-widget-icon",e.innerHTML="\u{1F4B0}",e.style.cssText=`
    ...
    `,document.body.appendChild(e),document.getElementById("widget-close-btn").addEventListener("click",()=>{y()})}function y(){let e=document.getElementById("shopee-commission-widget-panel");e&&(p=!p,e.style.display=p?"block":"none",p&&x())}async function x(){let e=m();if(!e){document.getElementById("widget-content").innerHTML=`
